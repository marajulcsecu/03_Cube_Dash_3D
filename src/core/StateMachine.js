...
export const ALLOWED_TRANSITIONS = {
  ...
  [STATES.TUTORIAL]: [STATES.RUNNING, STATES.COUNTDOWN, STATES.MENU, STATES.FATAL_ERROR],
  ...
  [STATES.PAUSED]: [STATES.RUNNING, STATES.COUNTDOWN, STATES.MENU, STATES.GAME_OVER, STATES.FATAL_ERROR],
